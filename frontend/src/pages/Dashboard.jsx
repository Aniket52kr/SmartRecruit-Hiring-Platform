...
// // Add Prop Validation for RecruiterInfoCard:-
RecruiterInfoCard.propTypes = {
  recruiterInfo: PropTypes.shape({
...
// // Add Prop Validation StatsCard:- 
StatsCard.propTypes = {
  candidates: PropTypes.arrayOf(
    PropTypes.shape({
      isCheating: PropTypes.bool.isRequired,
      aptitudeStatus: PropTypes.string.isRequired,
      techStatus: PropTypes.string.isRequired,
    })
  ).isRequired,
};
...
// // // Add Prop Validation for Candidate Rejection Modal:-
// CandidateRejectionModal.propTypes = {
...
// // // Add Prop Validation for Email model:-
